...
- [ ] Confirm/Implement `PUT /api/mentorships/{id}/accept` action.
- [ ] Confirm/Implement `PUT /api/mentorships/{id}/reject` action with string reason.
...
- [ ] Ensure the DTO returns `ChallengeDescription`.
